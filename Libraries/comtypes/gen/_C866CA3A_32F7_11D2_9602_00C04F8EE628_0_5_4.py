...
__all__ = [
    'eLEXTYPE_PRIVATE16', 'ISpeechMemoryStream', 'DISPID_SASetState',
    'DISPID_SVEStreamStart', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SFSClose',
    'DISPID_SOTCId', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechRecoResultTimes', 'SP_VISEME_4',
    'SAFTADPCM_11kHzMono', 'SVSFDefault', 'DISPID_SRRSaveToMemory',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRSTsCount',
    'DISPID_SPPChildren', 'SSSPTRelativeToCurrentPosition',
    'SPEI_SENTENCE_BOUNDARY', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRRPhraseInfo',
    'SRAInterpreter', 'DISPID_SpeechRecoResult2',
    'eLEXTYPE_PRIVATE18', 'SPCS_DISABLED', 'DISPID_SPRuleId',
    '_RemotableHandle', 'ISpeechWaveFormatEx', 'DISPID_SPPs_NewEnum',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVVoice', 'SAFT44kHz16BitStereo',
    'SPEI_SOUND_START', 'DISPID_SLGetGenerationChange',
    'SpeechTokenShellFolder', 'SpeechSpecialTransitionType',
    'SpMMAudioOut', 'Speech_Max_Word_Length', 'SVP_6',
    'SPDATAKEYLOCATION', 'SPEI_TTS_PRIVATE', 'ISpResourceManager',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPEI_MIN_SR',
    'DISPID_SVPriority', 'SRTExtendableParse',
    'DISPID_SpeechPhraseBuilder', 'ISpeechPhraseReplacement',
    'DISPID_SpeechPhraseRule', 'SpObjectTokenCategory',
    'SPEI_MIN_TTS', 'SPEI_ADAPTATION', 'SVP_20',
    'DISPID_SVSInputWordLength', 'SpCompressedLexicon',
    'DISPID_SRAudioInput', 'ISpGrammarBuilder', 'SINoise',
    'DISPID_SPEAudioStreamOffset', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpeechRecoResult', 'ISequentialStream',
    'DISPID_SPEPronunciation', 'SpeechLexiconType', 'SREStateChange',
    'SpeechTokenValueCLSID', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPEI_INTERFERENCE', 'SpeechUserTraining', 'DISPID_SPRs_NewEnum',
    'SRSActiveAlways', 'DISPID_SPARecoResult', 'SPSEMANTICFORMAT',
    'SP_VISEME_11', 'SPFM_CREATE_ALWAYS', 'DISPID_SRRSpeakAudio',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTPropertyName', 'SPRECOSTATE',
    'SPRULE', 'SPSHT_Unknown', 'DISPID_SLWsCount',
    'DISPID_SPCPhoneToId', 'ISpeechObjectTokenCategory',
    'SpeechVoiceEvents', 'DISPID_SGRsItem', 'SAFTGSM610_11kHzMono',
    'SP_VISEME_2', 'SPPS_Interjection',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPLO_DYNAMIC',
    'DISPID_SDKGetStringValue', 'DISPID_SLPsCount',
    'DISPID_SPRuleEngineConfidence', 'SRATopLevel',
    ...
    'SPINTERFERENCE_NOSIGNAL', 'ISpRecoCategory', 'SVP_17',
    'DISPID_SGRSAddWordTransition', 'SpShortcut', 'SP_VISEME_5',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCESoundEnd',
    'SRADefaultToActive', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_RESERVED2', 'ISpeechRecognizerStatus',
    'DISPID_SPAStartElementInResult', 'SPBOOKMARKOPTIONS',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SREmulateRecognition',
    'SpeechCategoryAudioIn', 'SRSActive', 'SDA_Two_Trailing_Spaces',
    'SASRun', 'SVEBookmark', 'SGLexical', 'SPCT_DICTATION',
    'DISPID_SRCEAdaptation', 'SAFTCCITT_uLaw_8kHzMono', 'SVEPrivate',
    'DISPID_SPEAudioSizeTime', 'SPPS_Unknown',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRCState',
    'SpeechRunState', 'SPEI_SOUND_END', 'DISPID_SRGCmdLoadFromObject',
    'ISpeechRecoContext', 'ISpeechPhoneConverter',
    'DISPID_SPRuleParent', 'DISPID_SPIEngineId',
    'SPADAPTATIONRELEVANCE', 'ISpeechRecoGrammar', 'SVSFNLPSpeakPunc',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SAFType',
    'DISPID_SWFEFormatTag', 'eLEXTYPE_RESERVED9',
    'DISPID_SLGenerationId', 'SpeechCategoryAppLexicons',
    'DISPID_SRCESoundStart', 'SPSEMANTICERRORINFO',
    'DISPID_SWFEChannels', 'SSTTWildcard',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPPNumberOfElements',
    'SPAR_Unknown', 'SPPHRASEPROPERTY', 'SpeechGrammarState',
    'DISPID_SPIElements', 'SpeechPropertyComplexResponseSpeed',
    'Speech_StreamPos_Asap', 'SpInprocRecognizer',
    'DISPID_SMSGetData', 'STSF_CommonAppData', 'SpSharedRecoContext',
    'DISPID_SVGetVoices', 'DISPID_SPIProperties',
    'ISpeechGrammarRule', 'DISPID_SFSOpen', 'SPPS_RESERVED3',
    'eLEXTYPE_RESERVED4', 'DISPID_SLRemovePronunciation',
    'SECNormalConfidence', 'SDTLexicalForm', 'SSTTTextBuffer',
    'SREHypothesis', 'STSF_FlagCreate', 'DISPID_SOTDataKey',
    'DISPID_SWFEBlockAlign', 'ISpeechLexiconWords', 'SPGS_ENABLED',
    'DISPID_SRCRetainedAudio', 'SpeechBookmarkOptions',
    'SPAUDIOSTATUS', 'SPINTERFERENCE_TOOQUIET', 'SPSMF_UPS',
    'STCInprocHandler', 'DISPID_SPRuleNumberOfElements',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechInterference',
    'SPDKL_CurrentConfig', 'SREAudioLevel', 'DISPID_SVPause',
    'SpeechWordPronounceable', 'SAFTGSM610_44kHzMono',
    'SPINTERFERENCE_TOOSLOW', 'SGRSTTWildcard',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVEViseme',
    'SRSEIsSpeaking', 'SGPronounciation', 'SBOPause',
    'DISPID_SpeechMemoryStream', 'DISPID_SGRSTRule',
    'DISPID_SRGDictationSetState', 'SpeechMicTraining', 'SVP_1',
    'DISPID_SVESentenceBoundary', 'SPPHRASEELEMENT', 'SGDSActive',
    'SRTEmulated', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SLAddPronunciationByPhoneIds', 'SP_VISEME_21',
    'DISPIDSPRG', 'SPEI_RECOGNITION', 'DISPID_SDKEnumKeys',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPVOICESTATUS', 'ISpStream',
    'DISPID_SPIAudioSizeTime', 'DISPID_SVSInputSentenceLength',
    'SpPhoneConverter', 'SSTTDictation', 'SpUnCompressedLexicon',
    'eLEXTYPE_RESERVED6', 'SAFTCCITT_uLaw_11kHzStereo', 'SPAO_NONE',
    'DISPID_SGRSTransitions', 'ISpRecoContext2',
    'SAFTADPCM_8kHzStereo', 'DISPID_SMSALineId', 'SpLexicon',
    'SVP_10', 'DISPID_SDKSetStringValue', 'DISPID_SRGReset',
    'SPSUnknown', 'SAFT11kHz16BitMono', 'SP_VISEME_7',
    'SpPhraseInfoBuilder', 'SRARoot', 'DISPID_SCSBaseStream',
    'SPPS_RESERVED4', 'SVP_16', 'ISpVoice', 'DISPID_SRCERecognition',
    'SPBINARYGRAMMAR', 'DISPID_SpeechGrammarRuleStateTransition',
    'SVP_14', 'SpeechEngineConfidence', 'SLOStatic',
    'SPRECORESULTTIMES', 'SAFT8kHz16BitStereo',
    'DISPID_SPPEngineConfidence', 'DISPID_SOTsItem', 'IStream',
    'ISpLexicon', 'DISPID_SABIMinNotification', 'SRCS_Disabled',
    'SPBO_PAUSE', 'SP_VISEME_10', 'DISPID_SASCurrentSeekPosition',
    'SAFT22kHz16BitMono', 'DISPID_SPRuleConfidence',
    'SAFT48kHz16BitStereo', 'SpeechDictationTopicSpelling',
    'DISPID_SDKDeleteValue', 'Speech_StreamPos_RealTime', 'SPWORD',
    'SPPARTOFSPEECH', 'SpNotifyTranslator',
    'DISPID_SpeechPhraseProperty', 'SpeechPropertyResourceUsage',
    'SASClosed', 'SRTReSent', 'SDTReplacement', 'ISpeechMMSysAudio',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTId', 'SPPHRASE',
    'SPPS_RESERVED2', 'DISPID_SPPName', 'DISPID_SPPsItem',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechGrammarRuleState',
    'STCInprocServer', 'DISPID_SOTs_NewEnum', 'SPGRAMMARSTATE',
    'SPFILEMODE', 'ISpeechPhraseInfoBuilder', 'SVP_4', 'SPWORDLIST',
    'ISpeechLexiconPronunciation', 'SPPS_Verb',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGIsPronounceable',
    'SPCT_SLEEP', 'DISPID_SAFGetWaveFormatEx', 'SPPS_Modifier',
    'SPSNotOverriden', 'SpeechLoadOption', 'DISPID_SPAs_NewEnum',
    'ISpPhrase', 'DISPID_SABIBufferSize', 'ISpEventSource',
    'SAFT16kHz8BitStereo', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVSLastStreamNumberQueued', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SOTCreateInstance', 'DISPID_SASState',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVAudioOutput',
    'DISPIDSPTSI_SelectionOffset', 'SPAR_High', 'SREBookmark',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SLPLangId', 'SPEVENT',
    'DISPID_SRCVoice', 'SpStreamFormatConverter', 'SDKLCurrentConfig',
    'SAFT48kHz8BitMono', 'SPRST_ACTIVE', 'DISPID_SRCEInterference',
    'SpSharedRecognizer', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVWaitUntilDone', 'DISPID_SDKGetlongValue',
    'DISPID_SOTGetDescription', 'SPAR_Medium', 'ISpRecoContext',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVEPhoneme',
    'DISPID_SRCEPropertyNumberChange', 'SVSFParseAutodetect',
    'SPAO_RETAIN_AUDIO', 'SPEI_MAX_SR', 'SLTUser',
    'ISpeechAudioFormat', 'SPPS_RESERVED1', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpeechBaseStream', 'SRESoundStart', 'DISPID_SPPParent',
    'DISPID_SPACommit', 'SPFM_OPEN_READWRITE', 'SVEAudioLevel',
    'DISPID_SRGDictationUnload', 'eLEXTYPE_PRIVATE12',
    'eLEXTYPE_PRIVATE17', 'DISPID_SOTIsUISupported', 'IEnumString',
    'SVSFIsFilename', 'STSF_LocalAppData', 'DISPID_SRIsShared',
    'SVPNormal', 'SPCT_SUB_DICTATION', 'SPINTERFERENCE_NONE',
    'SpeechAudioProperties', 'LONG_PTR', 'SECLowConfidence',
    'SpeechTokenIdUserLexicon', 'SPEI_VISEME', 'SVSFParseSapi',
    'DISPID_SGRsCommit', 'SAFTADPCM_8kHzMono', 'SPBO_TIME_UNITS',
    'SPEI_PHRASE_START', 'SpeechAudioFormatGUIDText',
    'DISPID_SPERetainedSizeBytes', 'SpeechAudioVolume',
    'DISPID_SVSpeakStream', 'SVP_9', 'DISPID_SGRId',
    'eLEXTYPE_PRIVATE9', 'SAFTNonStandardFormat', 'SDTAudio',
    'SAFT12kHz8BitStereo', 'SPVPRI_NORMAL', 'SSSPTRelativeToStart',
    'DISPID_SVEVoiceChange', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechGrammarRuleStateTransitions', 'SVSFIsXML', 'SPAS_PAUSE',
    'DISPID_SGRInitialState', 'SAFTCCITT_ALaw_44kHzMono',
    'SP_VISEME_20', 'SPSLMA', 'SPVISEMES', 'SPEI_REQUEST_UI',
    'ISpObjectToken', 'DISPID_SPPValue', 'SGRSTTEpsilon',
    'DISPID_SPERequiredConfidence', 'DISPID_SPIGetText',
    'DISPID_SpeechVoiceEvent', 'DISPID_SAStatus',
    'SAFT12kHz16BitStereo', 'DISPID_SRCEHypothesis',
    'DISPID_SRStatus', 'ISpeechGrammarRuleStateTransition',
    'eLEXTYPE_PRIVATE1', '_ISpeechVoiceEvents',
    'SpeechCategoryRecoProfiles', 'ISpeechPhraseElement',
    'SPSHT_OTHER', 'eLEXTYPE_PRIVATE11', 'SPEI_START_SR_STREAM',
    'SpeechAddRemoveWord', 'DISPID_SRGDictationLoad', 'ISpMMSysAudio',
    'eLEXTYPE_PRIVATE4', 'SAFT32kHz16BitStereo',
    'ISpeechXMLRecoResult', 'SpeechGrammarWordType', 'SAFTDefault',
    'DISPID_SOTCGetDataKey', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCCreateGrammar', 'SSFMOpenForRead', 'DISPID_SBSSeek',
    'DISPID_SVAudioOutputStream', 'SRADynamic',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechPhraseRules',
    'DISPID_SPEEngineConfidence', 'SP_VISEME_13',
    '_ISpeechRecoContextEvents', 'DISPID_SVSkip',
    'SAFT8kHz8BitStereo', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechRecoContextEvents', 'ISpeechPhraseRules',
    'DISPID_SpeechRecoContext', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVSPhonemeId', 'WAVEFORMATEX', 'SAFTGSM610_8kHzMono',
    'SVEWordBoundary', 'SP_VISEME_19', 'SPRST_NUM_STATES',
    'DISPID_SVDisplayUI', 'DISPID_SGRName', 'SPSInterjection',
    'DISPID_SPEDisplayText', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRRecognizer', 'DISPID_SVVolume', 'SPDKL_DefaultLocation',
    'SP_VISEME_0', 'SAFT11kHz16BitStereo', 'SpeechVisemeType',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechRecognizer', 'SFTSREngine', 'DISPID_SVEWord',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCResume',
    'DISPID_SGRsDynamic', 'ISpNotifySink', 'SRTSMLTimeout',
    'SPWF_SRENGINE', 'SPAS_STOP', 'SREPropertyStringChange',
    'SPEI_MAX_TTS', 'DISPID_SLWPronunciations',
    'SPINTERFERENCE_NOISE', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCEBookmark', 'DISPID_SABIEventBias',
    'SAFT8kHz16BitMono', 'ISpNotifySource',
    ...
    'SPFM_CREATE', 'DISPID_SLGetWords',
    'SpeechCategoryPhoneConverters', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechMMSysAudio', 'SPVPRI_OVER', 'DISPID_SAEventHandle',
    'SPCATEGORYTYPE', 'DISPID_SOTDisplayUI',
    'DISPID_SWFESamplesPerSec', 'SVEViseme', 'DISPID_SGRSTNextState',
    'ISpeechPhraseProperty', 'SpeechRuleAttributes',
    'DISPID_SVEAudioLevel', 'DISPID_SRGRecoContext', 'SGSEnabled',
    'SPAS_RUN', 'SPWAVEFORMATTYPE', 'STCRemoteServer', 'ISpeechVoice',
    'ISpeechRecoResult2', 'DISPID_SPEsItem', 'ISpObjectTokenCategory',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRRRecoContext', 'eLEXTYPE_PRIVATE5', 'DISPID_SLWLangId',
    'SPSHORTCUTTYPE', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_TTS_AUDIO_LEVEL',
    'SPEI_PHONEME', 'DISPID_SPIRetainedSizeBytes', 'SRSInactive',
    'eLEXTYPE_APP', 'DISPID_SVEEnginePrivate', 'SP_VISEME_3',
    'SPRST_INACTIVE', 'DISPID_SABufferInfo', 'DISPID_SRGRules',
    'SpeechRecognizerState', 'DISPID_SpeechPhraseReplacement',
    'SpNullPhoneConverter', 'ISpeechLexicon', 'SDTAll',
    'SPEI_WORD_BOUNDARY', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechGrammarRules', 'SPLO_STATIC', 'DISPID_SOTRemove',
    'SVP_12', 'ISpShortcut', 'DISPID_SpeechGrammarRule',
    'SP_VISEME_8', 'SVESentenceBoundary', 'DISPID_SLWType',
    'DISPID_SPRsItem', 'DISPID_SOTsCount', 'ISpRecognizer2',
    'DISPID_SRCERequestUI', 'SpeechFormatType', 'SRTAutopause',
    'ISpeechRecoResultTimes', 'DISPID_SpeechXMLRecoResult', 'SVP_11',
    'DISPID_SPRulesCount', 'SLODynamic', 'DISPID_SLPType',
    'SPWORDPRONUNCIATION', 'SPINTERFERENCE', 'DISPID_SPPConfidence',
    'DISPID_SDKEnumValues', 'SWTAdded', 'SVSFParseMask',
    'SpTextSelectionInformation', 'SPWORDTYPE', 'SREFalseRecognition',
    'SPEI_UNDEFINED', 'DISPID_SOTGetAttribute', 'SECHighConfidence',
    'SPVPRIORITY', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVGetProfiles',
    'SPSHT_NotOverriden', 'DISPID_SRSClsidEngine',
    'DISPID_SPRuleFirstElement', 'ISpProperties', 'DISPID_SOTSetId',
    'ISpeechAudioBufferInfo', 'ISpAudio', 'DISPID_SVEventInterests',
    'DISPID_SpeechAudioFormat', 'DISPIDSPTSI_ActiveLength',
    'ISpeechDataKey', 'SPSERIALIZEDPHRASE', 'SVF_None',
    'SAFT44kHz8BitStereo', 'SPSHT_EMAIL', 'DISPID_SGRClear',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRRAudio', 'DISPID_SAVolume', 'DISPID_SRCBookmark',
    'DISPID_SRGId', 'SRSEDone', 'SVP_3', 'DISPID_SRCEPhraseStart',
    'DISPID_SLPs_NewEnum', 'DISPID_SGRAttributes',
    'SPDKL_LocalMachine', 'SLTApp', 'ISpNotifyTranslator',
    'SpWaveFormatEx', 'SPLEXICONTYPE', 'SPLOADOPTIONS',
    'SDTAlternates', 'DISPID_SpeechPhraseProperties',
    'SPEI_FALSE_RECOGNITION', 'ISpeechObjectToken',
    'SpeechStreamSeekPositionType', 'SpeechRetainedAudioOptions',
    'STCLocalServer', 'SRERecognition', 'DISPID_SRCRecognizer',
    'SpeechWordType', 'SPRS_INACTIVE',
    'DISPID_SRGSetWordSequenceData', 'ISpeechAudio', 'SpMemoryStream',
    'DISPID_SPPFirstElement', 'SPEI_RESERVED3',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVSLastBookmark',
    'SREAllEvents', 'DISPID_SGRSTText', 'ISpeechResourceLoader',
    'eWORDTYPE_ADDED', 'SVF_Stressed', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRDisplayUI', 'SPEI_RESERVED1', 'SAFTADPCM_22kHzStereo',
    'DISPID_SpeechLexiconProns', 'DISPID_SDKCreateKey', 'SGRSTTRule',
    'SPSModifier', 'DISPID_SADefaultFormat', 'DISPID_SMSSetData',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCRequestedUIType',
    'SREStreamEnd', 'eLEXTYPE_RESERVED8', 'DISPID_SAFGuid',
    'SAFT24kHz8BitStereo', 'SPPS_SuppressWord', 'SVP_0',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SOTMatchesAttributes',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPRsCount', 'SVSFlagsAsync',
    'ISpeechGrammarRules', 'DISPID_SRGetFormat',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRSTPropertyValue',
    'SRERecoOtherContext', 'DISPID_SLPPartOfSpeech',
    'SpeechDisplayAttributes', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRSCurrentStreamNumber', 'SpeechCategoryAudioOut',
    ...
    'DISPID_SVStatus', 'SAFTADPCM_44kHzStereo', 'DISPID_SVEBookmark',
    'ISpeechFileStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SRSInactiveWithPurge', 'DISPID_SGRsCount', 'SDKLDefaultLocation',
    'SPSTREAMFORMATTYPE', 'SPXMLRESULTOPTIONS',
    'ISpeechPhraseReplacements', 'DISPID_SPILanguageId',
    'DISPID_SDKSetLongValue', 'SVSFParseSsml',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVSLastBookmarkId',
    'SpVoice', 'SAFTText', 'SPSVerb', 'SAFTNoAssignedFormat',
    'SPVPRI_ALERT', 'DISPID_SRCEAudioLevel', 'DISPID_SRRTimes',
    'SDKLCurrentUser', 'SPPS_Noun', 'eLEXTYPE_PRIVATE3',
    'SGSDisabled', 'DISPID_SLAddPronunciation',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_9', 'eLEXTYPE_USER',
    'DISPID_SpeechPhraseReplacements', 'SpeechCategoryRecognizers',
    'SAFT11kHz8BitMono', 'SPFM_OPEN_READONLY',
    'SpeechRecoContextState', 'DISPID_SGRsAdd', 'DISPID_SPPsCount',
    'ISpRecognizer3', 'DISPID_SVSLastResult', 'DISPID_SPIGrammarId',
    'SVPOver', 'SFTInput', 'SRTStandard', 'SPEVENTSOURCEINFO',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPRuleChildren', 'SVP_19',
    '_SPAUDIOSTATE', 'SDTPronunciation', 'DISPID_SPRulesItem',
    'SREPhraseStart', 'DISPID_SPELexicalForm',
    'DISPID_SRGCmdLoadFromFile', 'SVEAllEvents', 'SpMMAudioEnum',
    'DISPID_SRCEEnginePrivate', 'SpStream', 'ISpEventSink',
    'SAFT22kHz8BitStereo', 'DISPID_SPEAudioSizeBytes',
    'ISpStreamFormatConverter', 'SECFDefault', 'SGRSTTDictation',
    'DISPID_SGRSTType', 'SREInterference', 'DISPID_SMSAMMHandle',
    'DISPID_SRGetRecognizers', 'DISPID_SRRTTickCount',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPCLangId',
    'SPWT_PRONUNCIATION', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseAlternates',
    'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechObjectTokens',
    'DISPID_SPRText', 'SpeechRecoEvents', 'DISPID_SVRate',
    'ISpeechPhraseRule', 'DISPID_SVSyncronousSpeakTimeout',
    'SPFM_NUM_MODES', 'SPEI_SR_PRIVATE', 'DISPID_SGRSTWeight',
    'SITooFast', 'ISpPhoneticAlphabetSelection', 'DISPID_SDKOpenKey',
    'ISpRecoResult', 'SVF_Emphasis', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPRNumberOfElements', 'SWPKnownWordPronounceable',
    'tagSPTEXTSELECTIONINFO', 'SVEStartInputStream',
    'DISPID_SPEDisplayAttributes', 'SVP_2',
    'DISPID_SpeechPhraseElement', 'SPSHORTCUTPAIR',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRRTStreamTime',
    'IInternetSecurityMgrSite', 'SVP_21', 'SPEI_VOICE_CHANGE',
    'SPPS_LMA', 'SRAONone', 'ISpeechPhraseInfo',
    'DISPID_SVSInputWordPosition', 'ISpRecoGrammar',
    ...
    'IEnumSpObjectTokens', 'DISPID_SGRAddResource', 'SDTRule',
    'SGDSInactive', 'SGDSActiveWithAutoPause', 'SAFT48kHz8BitStereo',
    'SGDisplay', 'SVP_13', 'SPCT_COMMAND', 'DISPID_SVResume',
    'SAFT12kHz8BitMono', 'SAFT32kHz16BitMono', 'SITooLoud',
    'SAFT24kHz16BitStereo', 'SP_VISEME_16', 'SGRSTTTextBuffer',
    'DISPID_SRProfile', 'eLEXTYPE_PRIVATE2',
    'DISPID_SOTCEnumerateTokens', 'ISpPhoneConverter',
    'SAFTADPCM_44kHzMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVSFVoiceMask', 'DISPID_SRRTLength', 'SITooSlow', 'SP_VISEME_15',
    'SAFT22kHz8BitMono', 'tagSPPROPERTYINFO', 'SVP_7',
    'DISPID_SRCEStartStream', 'SP_VISEME_17', 'SAFT32kHz8BitStereo',
    'SVEVoiceChange', 'SPSSuppressWord', 'SREPropertyNumChange',
    'SVP_18', 'SPCS_ENABLED', 'SPEVENTENUM', 'SASPause',
    'DISPID_SDKDeleteKey', 'DISPID_SWFEExtraData',
    'DISPID_SRCEventInterests', 'eLEXTYPE_PRIVATE7',
    'SpeechPropertyAdaptationOn', 'DISPID_SPAsCount', 'SPWT_LEXICAL',
    'eLEXTYPE_RESERVED7', 'SP_VISEME_18', 'DISPID_SPIStartTime',
    ...
    'DISPID_SBSWrite', 'SVSFUnusedFlags', 'DISPID_SDKGetBinaryValue',
    'ISpeechLexiconPronunciations', 'SpeechGrammarTagDictation',
    'SPGRAMMARWORDTYPE', 'DISPID_SRGCommit', 'SAFT16kHz16BitStereo',
    'SVP_5', 'DISPID_SpeechPhraseInfo', 'DISPID_SRSAudioStatus',
    'SpeechPropertyResponseSpeed', 'SPSFunction',
    'DISPID_SABufferNotifySize', 'SBONone', 'SpeechVisemeFeature',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCPause', 'SPBO_NONE',
    'DISPID_SLGetPronunciations', 'SPEI_END_INPUT_STREAM',
    'SSFMOpenReadWrite', 'ISpeechPhraseProperties',
    'DISPID_SASNonBlockingIO', 'SPGS_DISABLED', 'DISPID_SGRsFindRule',
    'DISPID_SGRSRule', 'DISPID_SpeechBaseStream', 'SRAImport',
    'DISPID_SRCreateRecoContext', 'DISPID_SVSRunningState',
    'DISPID_SGRSTsItem', 'DISPID_SPIAudioStreamPosition',
    'SpeechDataKeyLocation', 'eLEXTYPE_RESERVED10',
    'DISPID_SBSFormat', 'SPPROPERTYINFO',
    'DISPID_SpeechAudioBufferInfo', 'SECFIgnoreCase',
    'DISPID_SPEsCount', 'SpeechRuleState', 'DISPID_SPIAudioSizeBytes',
    'SAFT24kHz8BitMono', 'SAFT44kHz8BitMono',
    ...
    'SP_VISEME_12', 'SAFTGSM610_22kHzMono', 'SPPS_NotOverriden',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCEEndStream',
    'SPRECOCONTEXTSTATUS', 'ISpeechVoiceStatus', 'SPEI_RESERVED6',
    'DISPID_SpeechFileStream', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechRecoResult', 'SPRULESTATE',
    'DISPID_SGRSAddRuleTransition', 'SpeechAllElements',
    'DISPID_SRRAudioFormat', 'SpeechDiscardType',
    'SpeechAudioFormatType', 'DISPID_SPERetainedStreamOffset',
    'SECFEmulateResult', 'SVSFIsNotXML', 'ISpRecognizer',
    'SAFT12kHz16BitMono', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPISaveToMemory', 'SPEI_TTS_BOOKMARK', 'SVP_15',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechObjectTokens', 'ISpeechAudioStatus',
    'eLEXTYPE_PRIVATE10', 'SPEI_SR_BOOKMARK', 'DISPID_SPEs_NewEnum',
    'DISPID_SOTCDefault', 'SpPhoneticAlphabetConverter',
    'SVSFNLPMask', 'DISPID_SPAPhraseInfo', 'SPXRO_Alternates_SML',
    'SPDKL_CurrentUser', 'SDKLLocalMachine',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechVoiceStatus',
    'SPPS_Noncontent', 'DISPID_SpeechPhraseElements',
    'SGLexicalNoSpecialChars', 'DISPID_SLPSymbolic',
    'SSSPTRelativeToEnd', 'SVSFPurgeBeforeSpeak', 'ISpPhraseAlt',
    'Speech_Default_Weight', 'DISPID_SGRs_NewEnum', 'SPWF_INPUT',
    'SpeechAudioFormatGUIDWave', 'SPRS_ACTIVE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT44kHz16BitMono',
    'DISPID_SpeechObjectTokenCategory', 'SpeechTokenKeyAttributes',
    'SpeechVoicePriority', 'DISPID_SASFreeBufferSpace',
    'SpeechAudioState', 'UINT_PTR', 'SPEI_RECO_STATE_CHANGE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRState',
    'DISPID_SRGSetTextSelection', 'SASStop', 'SpAudioFormat',
    'DISPID_SVSpeak', 'DISPID_SVEStreamEnd', 'DISPID_SpeechAudio',
    'DISPID_SAFSetWaveFormatEx', 'tagSTATSTG', 'SAFT32kHz8BitMono',
    'DISPID_SRRGetXMLResult', 'SPXRO_SML', 'DISPID_SPPId',
    'Speech_Max_Pron_Length', 'DISPID_SPRFirstElement', 'SINone',
    'DISPID_SBSRead', 'SpResourceManager',
    'DISPID_SVSCurrentStreamNumber', 'SpeechPartOfSpeech',
    'SPEI_START_INPUT_STREAM', 'SVEPhoneme', 'SPEI_SR_AUDIO_LEVEL',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPANumberOfElementsInResult',
    'SpeechRecoProfileProperties', 'ISpXMLRecoResult',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechVoice', 'ISpRecoGrammar2', 'SVEEndInputStream',
    'eWORDTYPE_DELETED', 'SAFT11kHz8BitStereo', 'ISpeechLexiconWord',
    'DISPID_SRGState', 'DISPID_SpeechDataKey', 'DISPID_SPRuleName',
    'SpObjectToken', 'SECFIgnoreWidth', 'SAFT22kHz16BitStereo',
    'DISPID_SRGCmdSetRuleIdState', 'SDA_Consume_Leading_Spaces',
    'SVSFPersistXML', 'SpeechTokenContext', 'ISpSerializeState',
    'DISPID_SOTCategory', 'SpInProcRecoContext', 'SDTDisplayText',
    'DISPID_SWFEBitsPerSample', 'ISpStreamFormat', 'STSF_AppData',
    'DISPID_SWFEAvgBytesPerSec', 'SPPHRASERULE',
    'DISPIDSPTSI_SelectionLength', 'SRAExport',
    'ISpeechRecoResultDispatch', 'DISPIDSPTSI', 'DISPID_SLWWord',
    'SP_VISEME_6', 'SSFMCreate', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SLWsItem', 'SpeechEngineProperties', 'SAFT8kHz8BitMono',
    'SPWT_DISPLAY', 'SAFT48kHz16BitMono', 'SINoSignal',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPAsItem',
    'SpeechPropertyNormalConfidenceThreshold', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTPropertyId',
    'SP_VISEME_1', 'SPSERIALIZEDRESULT', 'SPCONTEXTSTATE',
    ...
    'DISPID_SRRAlternates', 'DISPID_SVIsUISupported', 'SRERequestUI',
    'SVP_8', 'SAFTADPCM_11kHzStereo', 'SAFTExtendedAudioFormat',
    'SECFNoSpecialChars', 'SpeechEmulationCompareFlags',
    'SpeechGrammarTagWildcard', 'SGSExclusive', 'DISPID_SMSADeviceId',
    'SREStreamStart', 'DISPID_SpeechLexicon', '__MIDL_IWinTypes_0009',
    'ISpeechTextSelectionInformation', 'SpCustomStream',
    'SpeechTokenKeyFiles', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLPsItem', 'SpeechVoiceSpeakFlags', 'STCAll',
    'SITooQuiet', 'SPSNoun', 'SPCT_SUB_COMMAND',
    'ISpeechPhraseAlternate', 'SVPAlert', 'SRCS_Enabled',
    'ISpeechCustomStream', 'SREAdaptation', 'SDA_One_Trailing_Space',
    'ISpeechRecognizer', 'SDTProperty', 'DISPID_SDKSetBinaryValue',
    'ISpeechPhraseAlternates', 'ISpDataKey', 'SpeechRegistryUserRoot',
    'SpeechTokenKeyUI', 'SPPHRASEREPLACEMENT', 'DISPID_SGRAddState',
    'SpFileStream', 'SPAUDIOOPTIONS', 'DISPID_SLPPhoneIds',
    'DISPID_SPIRule', 'SPAUDIOSTATE', 'SPBO_AHEAD',
    'SPTEXTSELECTIONINFO', 'SRESoundEnd', 'SWTDeleted', 'SREPrivate',
    'SRAORetainAudio', 'SPAUDIOBUFFERINFO',
    'SAFTCCITT_uLaw_11kHzMono', 'SSFMCreateForWrite', 'SPAR_Low',
    ...
    'DISPID_SpeechObjectToken', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRIsUISupported'
]

_check_version('1.2.1', 1699545925.324644)
